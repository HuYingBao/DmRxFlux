...
public class ConfirmFragment extends BaseDialogFragment {
    ...
    public void onCancelClicked() {
        ...
        if (!TextUtils.isEmpty(secondAction))
            mActionCreator.postLocalAction(secondAction, ActionsKeys.CONTEXT, mContext);
        dismiss();
    }

    @OnClick(R.id.tv_ok)
    public void onOkClicked() {
        mActionCreator.postLocalAction(getArguments().getString(ActionsKeys.BASE_ACTION), ActionsKeys.CONTEXT, mContext);
        dismiss();
    }
}
