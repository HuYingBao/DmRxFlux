...
public interface ApplicationComponent {
    ...
    void inject(LoginStore loginStore);

    void inject(MainStore mainStore);

    void inject(DeviceListStore deviceListStore);

    void inject(InspectionUserAdapter inspectionAdapter);

    void inject(MaintainItemAdapter maintainItemAdapter);
}
